...
extern "C" {
#endif // __cplusplus
    extern void calculate_trend_analysis_debug(double * input, uint64_t count, double * a_buff, double * at_buff, double * ata_buff, double * ata_inv_buff, double * ata_inv_at_buff, double * convolution_coefficient, double * convolution_coefficient_buff, uint64_t polynomial_order, uint64_t window_size, double * output);
