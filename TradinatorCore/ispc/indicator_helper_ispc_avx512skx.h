...
extern "C" {
#endif // __cplusplus
    extern void calculate_bollinger_band(double * input, double * top_output, double * sma_output, double * bottom_output, uint32_t data_size, uint32_t window_size, double standard_deviation_multiplier);
