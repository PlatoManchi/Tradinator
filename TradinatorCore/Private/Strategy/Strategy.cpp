...
std::vector<bool> Long_Strategy_1::Check(const CandlesData& candles_data)
{
	...
	for (size_t i = delta_length; i < count; ++i)
	{
		...
		// Rule 1: Short Term Moving Average crossing Long Term Moving Average
		// from below to above
		...
		// Rule 2: RSI crossing above 50 level from below
		...
		// Rule 3: MACD moving above signal line or zero line.
